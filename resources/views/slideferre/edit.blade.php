...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <form method="POST" action="{{route('slideferreteria.update',$slidefer->id )}}" enctype="multipart/form-data">
                @csrf
                <div class="form-row">
                    <div class="col-md-3">
                        <div class="position-relative form-group">
                            ...
                            <input name="name" id="nombre" placeholder="demosle un nombre" type="text"
                                class="form-control" value="{{ old('name',$slidefer->name)  }}">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="position-relative form-group">
                            ...
                            <input name="description" id="descripcion" placeholder="¿de que trata?" type="text"
                                class="form-control" value="{{ old('description',$slidefer->description) }}">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-3">
                        <div class="position-relative form-group">
                            ...
                            <p class="help-block alert alert-danger">Subir una imagen solo si desea remplazar la
                                <a href="{{ asset('/images/categories/'.$slidefer->image) }}" target="_blank"> imagen
                                    actual</a>
                            </p>
                            @endif
                        </div>
                ...
                <div class="row">
                    <div class=" form-group col-sm-4">
                        ...
                        <a href="{{ route('slideferreteria') }}" class="mb-2 mr-2 btn btn-danger">Cancelar</a>
                    </div>
                </div>
            </form>
        </div>
