...
@section('title','Edición de Rol |' .config('app.name'))
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Edición de Rol</h1>
            ...
            <form method="POST" action="{{route('roles.update',$role->id)}}" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" name="name" id="inputEmail3"
                            placeholder="Algun nombre..." value="{{ old('name',$role->name) }}">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" name="slug" id="inputPassword3"
                            placeholder="ex: productos" value="{{  old('slug',$role->slug) }}">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input type="text" name="description" class="form-control" id="inputPassword4"
                            placeholder="Alguna Descripción" value="{{ old('description',$role->description) }}">
                    </div>
                </div>
                <hr>
                ...
                <div class="row">
                    <div class=" form-group col-sm-4">
                        <button class="mb-1 mr-1 btn btn-success" type="submit">Editar Rol</button>
