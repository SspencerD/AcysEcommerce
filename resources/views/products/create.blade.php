            ...
            <form action="{{ route('products.store') }}" method="POST">
                ...
                <div class="form-row">
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" name="provider_code" class="form-control" id="provider_code"
                            placeholder="SKU939232" value="{{ old('provider_code')}}">
                    </div>
                    <div class="form-group col-md-4">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-sm-4">
                        ...
                        <input type="number" step="00.000,00" name="purchase_price" class="form-control"
                            id="purchase_price" value="{{ old('pruchase_price')}}">
                    </div>
                </div>
                <div class="form-row">
